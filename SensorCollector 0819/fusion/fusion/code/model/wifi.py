...
class WifiNetwork(tf.Module):
    # Create model
    def __init__(self, input_dim, rp_locs, rp_features, n_layers=3, embedding_dim=32, mask_fraction=0.1,
...
class WiFiPreprocessor():
    ...
    def fit(self, X, y, ap_list1, ap_list2, grid_list):
        ...
        newX = self._feature_mapping(X, ap_list1)
